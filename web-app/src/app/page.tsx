    ...
    return (
        <div className="m-0 p-0 h-screen w-screen overflow-hidden box-border flex flex-col gap-20 bg-landing">
          <div className="mt-3 navbar flex box-border items-center justify-between w-screen h-16">
            <div className=" w-64 ml-5 flex items-center relative">
              <input className="drop-shadow-2xl opacity-60 rounded-2xl w-full pl-4 shadow-lg h-9" type="search" name="" placeholder="Search" id="" />
              <button className="drop-shadow-2xl flex items-center justify-center"><Image src={search} alt="search icon" className="w-9 absolute right-0 pr-4 object-contain" /></button>
            </div>
            <div className="buttons mr-10 text-black  flex box-border gap-2">
              <Link className="w-28" href="/login"><button className="drop-shadow-2xl font-semibold tracking-wider bg-white transition-all duration-250 hover:text-white hover:bg-buttons h-10 w-28 rounded-3xl">LOGIN</button></Link>
              <Link className="w-28" href="/join"><button className="drop-shadow-2xl font-semibold tracking-wider bg-white transition-all duration-250 hover:text-white hover:bg-buttons h-10 w-28 rounded-3xl">JOIN</button></Link>
            </div>
          </div>
